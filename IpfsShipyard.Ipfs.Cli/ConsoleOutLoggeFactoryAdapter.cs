...
namespace IpfsShipyard.Ipfs.Cli;
...
public class ConsoleOutLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
{
    ...
    /// </summary>
    public ConsoleOutLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel,
        string dateTimeFormat, bool useColor)
    ...
    {
#if !SILVERLIGHT
        ILog log = new ConsoleOutLogger(name, level, showLevel, showDateTime, showLogName, dateTimeFormat, _useColor);
#else
